...
public class SimpleEmail {
  ...
  public void sendMessage(String message,String to){
        try {
            SimpleEmail javaEmail = new SimpleEmail();
            javaEmail.setMailServerProperties();
            javaEmail.createEmailMessage(message, to);
            javaEmail.sendEmail();
  ...
  public void createEmailMessage(String message,String to) throws AddressException,
      MessagingException {
    String[] toEmails = { to };
    String emailSubject = "Authentication";
 ...
 public void createEmailMessages(String message, String[] toEmails) throws AddressException,
  ...
  public void sendEmail() throws AddressException, MessagingException {
    ...
    String fromUserEmailPassword = "trymelater";
