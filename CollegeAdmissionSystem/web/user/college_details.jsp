    ...
    <div>
        ...
        <%
                    ...
                    String query = "select college_id,	college_name,	description,	address,	eligibility from tblcollege_details "
                            + "where college_name like '%"+search+"%' or eligibility like '%"+search+"%'";
                    ...
                    while (rs.next()) {
                        ...
                        out.println("<tr>"
                                ...
                                + "<td>" + "<a href='view_streams.jsp?cid=" + rs.getString(1)+"'>" + " View Streams</a>" + "</td>"
                    ...
                    if (count == 0) {
                        out.println("<tr><td colspan='4'> No College Found..!! </td></tr>");
                    }
        %>
    </table>
